...
addAnimal("minecraft:cow", {item: "minecraft:leather"}, 0, {tag: "forge:buckets/milk"});
addAnimal("minecraft:donkey", {item: "minecraft:leather"});
...
addAnimal("minecraft:rabbit", {tag: "forge:crops/carrots"});
