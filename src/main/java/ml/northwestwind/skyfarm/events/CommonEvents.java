...
import ml.northwestwind.skyfarm.common.world.biome.SkyblockMiningBiomeProvider;
import ml.northwestwind.skyfarm.common.world.generators.SkyblockChunkGenerator;
import ml.northwestwind.skyfarm.common.world.generators.SkyblockMiningChunkGenerator;
...
public class CommonEvents {
    ...
    public static void commonSetup(final FMLCommonSetupEvent event) {
        ...
        SkyblockMiningChunkGenerator.init();
        SkyblockMiningBiomeProvider.init();
